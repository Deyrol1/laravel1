...
class FillPermissionsForHabitacion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHabitacion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.habitacion',
            'admin.habitacion.index',
            'admin.habitacion.create',
            'admin.habitacion.show',
            'admin.habitacion.edit',
            'admin.habitacion.delete',
            'admin.habitacion.bulk-delete',
        ]);
