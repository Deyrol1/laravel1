...
class FillPermissionsForEstadohabitacion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEstadohabitacion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.estadohabitacion',
            'admin.estadohabitacion.index',
            'admin.estadohabitacion.create',
            'admin.estadohabitacion.show',
            'admin.estadohabitacion.edit',
            'admin.estadohabitacion.delete',
            'admin.estadohabitacion.bulk-delete',
        ]);
