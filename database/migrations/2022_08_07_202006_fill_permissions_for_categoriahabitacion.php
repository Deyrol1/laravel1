...
class FillPermissionsForCategoriahabitacion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategoriahabitacion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categoriahabitacion',
            'admin.categoriahabitacion.index',
            'admin.categoriahabitacion.create',
            'admin.categoriahabitacion.show',
            'admin.categoriahabitacion.edit',
            'admin.categoriahabitacion.delete',
            'admin.categoriahabitacion.bulk-delete',
        ]);
